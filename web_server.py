...
def load_mods():
    """Charge les règles de filtrage depuis mods.json."""
...
def filter_csv(input_csv, output_csv, processing_mode):
    """Filtre les fichiers du CSV en fonction des exclusions définies dans mods.json."""
    mods = load_mods()
...
def process_file():
    """Traite le fichier MFT et applique un filtrage selon le mode choisi."""
    try:
        ...
        return jsonify({'message': 'Traitement réussi', 'output_file': output_name})
...
def download_file(filename):
    """Permet de télécharger un fichier de sortie."""
    try:
